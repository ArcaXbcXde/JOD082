...
public class GuardAITemporary : MonoBehaviour {
     ...
     * 
     * *  -> Implementar navMesh para que o guarda possa desviar a parede caso haja uma entre ele e seu objetivo.
     * 
     * !BUG! O guarda fica devagar enquanto persegue o jogador.
     * !BUG! O guarda é empurrado com muita força pelo jogador.
     * 
     * ____________________________________________________________________________________________
     * VARIÁVEIS
     * ____________________________________________________________________________________________
    ...
    private void Awake() {
        ...
        // Insere a lista de todos os trechos do caminho do guarda no vetor
        trechos = new Vector3[meuCaminho.childCount];
        ...
        // for que passa os eixos X e Z dos trechos para o vetor
        ...
        // Atribui o objeto de navMesh ao agente do guarda e começa sua rotina de patrulha, mas se não conseguir manda uma mensagem de erro
        ...
        if (navMeshAgent != null) {
            ...
            Debug.LogError(gameObject.name + " não possui um nav mesh ligado a ele.");
        }
    }
    ...
    // Controla o tempo que o jogador foi visto pelo guarda
    ...
    // Controla o quão atento o guarda está
